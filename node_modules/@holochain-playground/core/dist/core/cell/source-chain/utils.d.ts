import { Hash, AgentPubKey, CellId, Element, Dictionary, DHTOp, SignedHeaderHashed, CapSecret } from '@holochain-open-dev/core-types';
...
export declare function valid_cap_grant(state: CellState, zome: string, fnName: string, provenance: AgentPubKey, secret: CapSecret | undefined): boolean;
