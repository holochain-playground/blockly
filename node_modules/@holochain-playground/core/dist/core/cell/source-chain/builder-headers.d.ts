import { Hash, AgentPubKey, Dna, AgentValidationPkg, Entry, EntryType, Create, Update, SignedHeaderHashed, Header, CreateLink, Delete, DeleteLink } from '@holochain-open-dev/core-types';
...
export declare function buildDeleteLink(state: CellState, base_address: Hash, link_add_address: Hash): DeleteLink;
